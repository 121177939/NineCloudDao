...
build='v2-0-9-cache101-secttempo1-eventoutcome1-cleanrepo1-huaweinet1-appdialogupdate1'
label='V2.0.9 CACHE101'
...
checks={
 ...
 'config':all(x in text('config.js') for x in [label,build,'cacheEpoch: 101']),
 ...
 'pages-method':baseline.get('deploymentMethod')=='github_actions_pages_artifact_clean_repository'
}
