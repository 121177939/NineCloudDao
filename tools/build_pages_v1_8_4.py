...
build_id = 'v1-8-4-cache85-bsect03-growth1-uifix1'
label = 'V1.8.4 CACHE85'
required = [
...
checks = {
    ...
    'baseline': baseline.get('sourceBaseline') == 'V1.8.4 CACHE84' and baseline.get('clientHotfix') == 'BSECT03_UIFIX1' and baseline.get('gmVersion') == 'ADMIN9 R15',
    ...
    'cache': 'nine-cloud-dao-v1.8.4-cache85-bsect03-growth1-uifix1' in sw and build_id in sw,
    ...
    'sect-ui-helpers': all(t in text('b-sect-v2.js') for t in ['function tabNav()','function metric(label, value']),
