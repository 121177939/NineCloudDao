...
build='v2-0-8-cache100-equipment-worldnews3-cleanrepo1-huaweinet1-appdialogupdate1'
label='V2.0.8 CACHE100'
...
checks={
 ...
 'config':all(x in text('config.js') for x in [label,build,'cacheEpoch: 100']),
