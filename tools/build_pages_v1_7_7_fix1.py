...
required=['.nojekyll','index.html','404.html','styles.css','app.js','config.js','update-guard.js','sw.js','manifest.webmanifest','b-paigow01.js','b-paigow01.css','b-paigow01.html','b-equipment01.js','b-equipment01.css','paigow-realtime.js','paigow-app.js','paigow-app.css','b-paigow02-ui.css','b-paigow02-ui03.css','b-paigow02-ui.js','VERSION.txt','CURRENT_BASELINE.json','release_config.json','assets/icon-192.png','assets/icon-512.png']
for rel in required:
...
runtime_texts=[text(x) for x in ['index.html','404.html','app.js','styles.css','config.js','update-guard.js','sw.js','manifest.webmanifest','b-paigow01.html','b-paigow01.js','b-equipment01.css','b-equipment01.js','paigow-app.js','paigow-realtime.js','paigow-app.css','b-paigow02-ui.css','b-paigow02-ui03.css','b-paigow02-ui.js']]
checks={
 'version':text('VERSION.txt').strip()=='V1.7.7 FIX1',
 'config':all(x in text('config.js') for x in ["version: '1.7.7 FIX1'","releaseLabel: 'V1.7.7 FIX1 CACHE57'","buildId: 'v1-7-7-fix1-cache57'",'cacheEpoch: 57']),
 'index':all(x in text('index.html') for x in ['<!-- version: V1.7.7 FIX1 CACHE57 -->','b-paigow01.js?v=v1-7-7-fix1-cache57','b-equipment01.js?v=v1-7-7-fix1-cache57','b-equipment01.css?v=v1-7-7-fix1-cache57']),
 'iframe-ui03':all(x in text('b-paigow01.html') for x in ['<html class="b-paigow02-ui b-paigow02-ui03"','paigow-realtime.js?v=v1-7-7-fix1-cache57','paigow-app.js?v=v1-7-7-fix1-cache57','B-PAIGOW02-UI02-PARITY-INLINE','id="bPaigow02Ui02Style"','id="bPaigow02Ui02Viewport"','b-paigow02-ui03.css?v=v1-7-7-fix1-cache57']),
 'paigow-ui03-runtime-opener':"ui: 'b-paigow02-ui03'" in text('b-paigow01.js'),
 ...
 'paigow-visible-version': 'V1.7.7 FIX1 CACHE57' in pg,
 ...
 'service-worker':all(x in sw for x in ['nine-cloud-dao-v1.7.7-fix1-cache57','paigow-realtime.js?v=v1-7-7-fix1-cache57','b-equipment01.js?v=v1-7-7-fix1-cache57','b-paigow02-ui.css?v=v1-7-7-fix1-cache57','b-paigow02-ui03.css?v=v1-7-7-fix1-cache57','b-paigow02-ui.js?v=v1-7-7-fix1-cache57']),
 'workflow-builder-present':"python3 tools/build_pages_v1_7_7_fix1.py" in wf and (root/'tools/build_pages_v1_7_7_fix1.py').is_file(),
 'ui03-final-page-guard': all(x in text('b-paigow01.html') for x in ['B-PAIGOW02-UI02-PARITY-INLINE','id="bPaigow02Ui02Style"','id="bPaigow02Ui02Viewport"','b-paigow02-ui03.css?v=v1-7-7-fix1-cache57']),
 'ui03-runtime-markup':all(x in pg for x in ['mobile-table-toolbar','table-center-status','data-toggle-info','V1.7.7 FIX1 CACHE57']),
 'ui03-runtime-style':all(x in text('b-paigow02-ui03.css') for x in ['B-PAIGOW02-UI03-RUNTIME-PARITY','.mobile-table-toolbar','.table-center-status','.self-zone','.side-stack']),
 ...
 'ui03-last-loaded':text('b-paigow01.html').find('b-paigow02-ui03.css') > text('b-paigow01.html').find('id="bPaigow02Ui02Style"'),
}
...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.7.7 FIX1 CACHE57','clientBuild':'v1-7-7-fix1-cache57','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
...
print(f'V1.7.7 FIX1 CACHE57 pages build PASS files={len(manifest)}')
