...
checks={
 ...
 'config':all(x in text('config.js') for x in [f"releaseLabel: '{label}'",f"buildId: '{build_id}'",'cacheEpoch: 90']),
 'baseline':baseline.get('sourceBaseline')=='V1.8.7 CACHE89' and baseline.get('clientHotfix')=='BSECT06_AUTONOMY2000' and baseline.get('gmVersion')=='ADMIN9 R19',
 'database':baseline.get('nextSqlNumber')==220 and str(baseline.get('sqlRevision'))=='210-219',
 ...
 'cache':'nine-cloud-dao-v1.8.8-cache90-bsect06-autonomy2000' in sw and build_id in sw,
