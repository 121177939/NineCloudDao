...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.0 FIX1 CACHE31','clientBuild':'v1-fix1-cache31','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
