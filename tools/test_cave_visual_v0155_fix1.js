...
const tests={
 ...
 'supported release build':config.includes("buildId: 'v1-fix4-cache34'")||config.includes("buildId: 'v1-fix3-cache33'")||config.includes("buildId: 'v1-fix2-cache32'")||config.includes("buildId: 'v1-fix1-cache31'")||config.includes("buildId: 'v0155-fix1-cache27'")
