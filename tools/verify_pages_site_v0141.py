...
ck('sw-cache','nine-cloud-dao-v0.14.1-fix7-cache4' in txt('sw.js'))

ck('html-cache-build',all(t in txt('index.html') for t in ['styles.css?v=0141-fix7-cache4','update-guard.js?v=0141-fix7-cache4','app.js?v=0141-fix7-cache4']))
...
m=json.loads(txt('PAGES_ARTIFACT_MANIFEST.json')); ck('manifest.version',m.get('version')=='V0.14.1' and m.get('clientBuild')=='v0141-fix7-cache4')
