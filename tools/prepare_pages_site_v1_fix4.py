...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.0 FIX4 CACHE34','clientBuild':'v1-fix4-cache34','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
