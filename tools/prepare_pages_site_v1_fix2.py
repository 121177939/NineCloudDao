...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.0 FIX2 CACHE32','clientBuild':'v1-fix2-cache32','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
