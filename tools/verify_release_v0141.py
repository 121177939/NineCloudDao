...
required=['index.html','404.html','app.js','styles.css','config.js','update-guard.js','sw.js','manifest.webmanifest','VERSION.txt','CURRENT_BASELINE.json','release_config.json','README.md','CHANGELOG.md','DESKTOP_UPDATE.md','.nojekyll','.github/workflows/deploy-pages.yml','database/V0.14.1/202607261700_v0141_spirit_stone_casino.sql','database/V0.14.1/202607261930_v0141_fix2_loss_pool_rate.sql','database/V0.14.1/202607262030_v0141_fix3_house_win_pool_rate.sql','database/V0.14.1/202607262130_v0141_fix4_duel_pool_payout.sql','database/V0.14.1/202607262230_v0141_fix4_cache1_release_control.sql','database/V0.14.1/202607270100_v0141_fix5_breakthrough_insight_route.sql','tools/verify_release_v0141.py','tools/sql_static_audit_v0141.py','tools/test_casino_render_v0141.js','tools/prepare_pages_site_v0141.py','tools/verify_pages_site_v0141.py']
...
ck('sw','nine-cloud-dao-v0.14.1-fix5-cache2' in txt('sw.js')); ck('css-release','Current release: Web Alpha 0.14.1' in txt('styles.css'))
b=json.loads(txt('CURRENT_BASELINE.json')); r=json.loads(txt('release_config.json')); ck('baseline',b.get('version')=='0.14.1' and b.get('databaseChange')=='BREAKTHROUGH_INSIGHT_ROUTE_FIX5' and b.get('gameplayBaseline')=='V0.14.1 FIX5'); ck('release',r.get('version')=='V0.14.1' and r.get('clientBuild')=='v0141-fix5-cache2' and r.get('pagesStagingDirectory')=='.pages-site')

html=txt('index.html'); guard=txt('update-guard.js'); sw=txt('sw.js')
for t in ['styles.css?v=0141-fix5-cache2','config.js?v=0141-fix5-cache2','update-guard.js?v=0141-fix5-cache2','app.js?v=0141-fix5-cache2']:
...
for t in ["CACHE_NAME = 'nine-cloud-dao-v0.14.1-fix5-cache2'", "request.mode === 'navigate'", 'networkFirst(request', 'SKIP_WAITING', 'clients.claim']:
...
ck('registry','## V0.14.1 FIX5' in txt('database/MIGRATION_REGISTRY.md') and '202607270100_v0141_fix5_breakthrough_insight_route.sql' in txt('database/MIGRATION_REGISTRY.md'))
