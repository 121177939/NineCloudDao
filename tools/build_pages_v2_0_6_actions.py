...
build='v2-0-6-cache98-equipment-worldnews3-pagesrecovery2-huaweinet1-appdialogupdate1'; label='V2.0.6 CACHE98'
...
checks={
 ...
 'config':all(x in text('config.js') for x in [label,build,'cacheEpoch: 98']),
