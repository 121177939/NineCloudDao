...
run('release metadata',[py,'tools/verify_release_v1_3.py','.'])
run('GitHub Pages workflow audit',[py,'tools/verify_github_pages_workflow_v1_3.py','.'])
for rel in ['app.js','config.js','update-guard.js','sw.js','b-paigow01.js','paigow-app.js']:
 run('node syntax '+rel,['node','--check',rel])
for rel in ['tools/prepare_pages_site_v1_3.py','tools/verify_pages_site_v1_3.py','tools/verify_release_v1_3.py','tools/verify_github_pages_workflow_v1_3.py','tools/sql_static_audit_v1_3.py','tools/test_paigow_browser_optional_v1_3.py','tools/ci_v1_3.py']:
 run('python syntax '+rel,[py,'-m','py_compile',rel])
run('V1.3 SQL audit',[py,'tools/sql_static_audit_v1_3.py','.'])
run('V1.3 feature test',['node','tools/test_features_v1_3.js','.'])
...
run('build pages',[py,'tools/prepare_pages_site_v1_3.py','.','.pages-site'])
run('verify pages',[py,'tools/verify_pages_site_v1_3.py','.pages-site'])
print('\nV1.3 CACHE41 CI PASS')
