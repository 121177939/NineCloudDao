...
ck('version',txt('VERSION.txt').strip()=='V0.14.7'); ck('cache','v0147-cache11' in txt('config.js')); ck('feature','rpcGetOpportunityHistoryV0147' in txt('app.js'))
m=json.loads(txt('PAGES_ARTIFACT_MANIFEST.json')); ck('manifest',m.get('clientBuild')=='v0147-cache11')
