...
files=['.nojekyll','index.html','404.html','styles.css','app.js','config.js','sw.js','manifest.webmanifest','VERSION.txt','CURRENT_BASELINE.json','release_config.json','assets/icon-192.png','assets/icon-512.png']
manifest=[]
for rel in files:
 src=root/rel
...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V0.14.1','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
