...
build='v2-0-7-cache99-equipment-worldnews3-cleanrepo1-huaweinet1-appdialogupdate1'
label='V2.0.7 CACHE99'
...
checks={
 ...
 'config':all(x in text('config.js') for x in [label,build,'cacheEpoch: 99']),
