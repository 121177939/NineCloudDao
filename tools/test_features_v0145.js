...
[
 ...
 ['new-techniques',app.includes('techniques_new')&&app.includes('techniques_duplicate')],['mastery',app.includes('mastery_points')],['commission-copy',app.includes('闲家赢家毛利润中收取5%庄家佣金')&&app.includes('佣金归当局庄家')],['system-fix7a',app.includes('系统庄沿用FIX7A')],
 ...
 ['old-protections',app.includes('输光后境界不变')&&app.includes('应局并立即开契')&&app.includes('showDivineNoticeModal')],['dealer-name',app.includes('荷老')&&!app.includes('何老')]
].forEach(([n,o])=>ck(n,o));
