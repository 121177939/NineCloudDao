...
[
 ...
 ['new-techniques',app.includes('techniques_new')&&app.includes('techniques_duplicate')],['mastery',app.includes('mastery_points')],['commission-copy',app.includes('毛利润的95%发给闲家')&&app.includes('5%作为庄家佣金')],['system-fix7a',app.includes('系统庄沿用FIX7A')],
