...
check('version',text('VERSION.txt').strip()=='V0.13.1')
check('html-version','0.13.1' in text('index.html') and '0.13.1' in text('404.html'))
...
check('manifest.version',manifest.get('version')=='V0.13.1')
