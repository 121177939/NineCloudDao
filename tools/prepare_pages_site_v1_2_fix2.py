...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.2 FIX2 CACHE39','clientBuild':'v1-2-fix2-cache39','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
