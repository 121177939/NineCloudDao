...
for(const [name,html,tokens] of [['lobby',lobby,['大堂','贵宾雅间','全服造化池','已取消每日次数限制','统一灵石']],['house',house,['灵骰问道','气运龟卜','赌注资源','快捷倍数','自定义赌注数量','确认落注并立即开局','3—10点为小','11—18点为大','豹子同样按点数归类','天命豹子','9/275','每2200局出现1次','败局余下95%']],['duel',duel,['贵宾雅间','灵拳对弈','五行灵拳','确认赌注并封招开桌','双方各押100','胜者共到账195','奖池增加5']],['pools',pools,['40%','60%','大堂每一局赌注的5%进入奖池','败者赌注的5%进入奖池、95%转给胜者','不会叠加个人中奖权重','未中滚存']]]) for(const t of tokens) if(!html.includes(t)) throw new Error(`${name} missing ${t}`);
