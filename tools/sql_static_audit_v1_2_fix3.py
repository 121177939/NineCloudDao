...
gate=read('SQL/81_V1.2_FIX3_CACHE40_牌九无闪烁与自定义底注发布门禁.sql');post=read('SQL/82_V1.2_FIX3_CACHE40_升级后检查.sql');main=read('SQL/72_V1.2_FIX1_九霄灵牌正式并线.sql')
ck('gate-transaction','begin;' in gate and 'commit;' in gate)
ck('gate-cache40',"release_name='V1.2 FIX3 CACHE40'" in gate and 'greatest(cache_epoch,40)' in gate)
ck('gate-no-rule-change','不修改牌型、概率、洗牌、赔率或资金结算' in gate)
ck('post-release','release_cache40' in post)
