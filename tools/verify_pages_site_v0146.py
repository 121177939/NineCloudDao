...
ck('version',txt('VERSION.txt').strip()=='V0.14.6'); ck('cache','v0146-cache10' in txt('config.js')); ck('feature','rpcGetOpportunityHistoryV0146' in txt('app.js'))
m=json.loads(txt('PAGES_ARTIFACT_MANIFEST.json')); ck('manifest',m.get('clientBuild')=='v0146-cache10')
