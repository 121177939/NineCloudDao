...
texts=[text(x) for x in runtime];build_id='v1-7-8-cache58';label='V1.7.8 CACHE58'
checks={
'version':text('VERSION.txt').strip()=='V1.7.8',
'config':all(t in text('config.js') for t in ["version: '1.7.8'","releaseLabel: 'V1.7.8 CACHE58'","buildId: 'v1-7-8-cache58'",'cacheEpoch: 58']),
...
'service-worker':all(t in sw for t in ['nine-cloud-dao-v1.7.8-cache58',f'b-secret-realm01.js?v={build_id}',f'paigow-app.js?v={build_id}']) and all(t not in sw for t in ['gm-admin','gm-operations']),
