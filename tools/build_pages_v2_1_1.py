...
build='v2-1-1-cache106-wboss01-equipmentforge1-admin21-sql233-pagesfix1-gatefix1'
label='V2.1.1 CACHE106'
required=[
...
checks={
 ...
 'config':all(x in text('config.js') for x in [label,build,'cacheEpoch: 106']),
 'release-json':release.get('releaseLabel')==label and release.get('cacheEpoch')==106 and release.get('buildId')==build and release.get('nextSqlNumber')==234,
 'database':baseline.get('nextSqlNumber')==234 and baseline.get('sqlRevision')=='211-221 + 229-233',
