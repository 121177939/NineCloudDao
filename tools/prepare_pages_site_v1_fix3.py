...
(out/'PAGES_ARTIFACT_MANIFEST.json').write_text(json.dumps({'version':'V1.0 FIX3 CACHE33','clientBuild':'v1-fix3-cache33','files':manifest},ensure_ascii=False,indent=2)+'\n','utf-8')
