...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001409" in gradle_props, "Android版本号不是CACHE109基线")
    check('APP_VERSION_NAME=2.1.1-cache109' in gradle_props, "Android版本名不是CACHE109基线")
    expected_build = "v2-1-1-cache109-equipmentdetail1-admin22-sql238"
    ...
    result = {
        ...
        "project": ROOT.name,
        "gameBaseline": "V2.1.1 CACHE109",
        "gameBuildId": expected_build,
        "databaseBaseline": "SQL211-221 + SQL229-238 (target; SQL238 gate pending)",
        "androidVersionCode": 2001409,
    }
