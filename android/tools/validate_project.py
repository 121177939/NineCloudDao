...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2000799" in gradle_props, "Android版本号不是CACHE99基线")
    check('APP_VERSION_NAME=2.0.7-cache99' in gradle_props, "Android版本名不是CACHE99基线")
    expected_build = "v2-0-7-cache99-equipment-worldnews3-cleanrepo1-huaweinet1-appdialogupdate1"
