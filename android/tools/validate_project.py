...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001415" in gradle_props, "Android版本号不是CACHE115基线")
    check('APP_VERSION_NAME=2.1.1-cache115' in gradle_props, "Android版本名不是CACHE115基线")
    expected_build = "v2-1-1-cache115-newserver-admin26r2-sql245"
    ...
    result = {
        ...
        "project": ROOT.name,
        "gameBaseline": "V2.1.1 CACHE115",
        "gameBuildId": expected_build,
        "databaseBaseline": "production SQL244 passed; SQL245 R2 required before CACHE115",
        "androidVersionCode": 2001415,
    }
