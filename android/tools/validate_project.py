...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2000900" in gradle_props, "Android版本号不是CACHE100基线")
    check('APP_VERSION_NAME=2.0.8-cache100' in gradle_props, "Android版本名不是CACHE100基线")
    expected_build = "v2-0-8-cache100-equipment-worldnews3-cleanrepo1-huaweinet1-appdialogupdate1"
