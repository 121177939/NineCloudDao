...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001001" in gradle_props, "Android版本号不是CACHE101基线")
    check('APP_VERSION_NAME=2.0.9-cache101' in gradle_props, "Android版本名不是CACHE101基线")
    expected_build = "v2-0-9-cache101-secttempo1-eventoutcome1-cleanrepo1-huaweinet1-appdialogupdate1"
