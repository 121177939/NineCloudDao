...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001411" in gradle_props, "Android版本号不是CACHE111基线")
    check('APP_VERSION_NAME=2.1.1-cache111' in gradle_props, "Android版本名不是CACHE111基线")
    expected_build = "v2-1-1-cache111-totalstatsfix-admin22-sql240"
    ...
    result = {
        ...
        "project": ROOT.name,
        "gameBaseline": "V2.1.1 CACHE111",
        "gameBuildId": expected_build,
        "databaseBaseline": "SQL211-221 + SQL229-240 (target; SQL240 gate pending)",
        "androidVersionCode": 2001411,
    }
