...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001406" in gradle_props, "Android版本号不是CACHE106基线")
    check('APP_VERSION_NAME=2.1.1-cache106' in gradle_props, "Android版本名不是CACHE106基线")
    expected_build = "v2-1-1-cache106-wboss01-equipmentforge1-admin21-sql233-pagesfix1-gatefix1"
