...
def main() -> None:
    ...
    check("APP_VERSION_CODE=2001410" in gradle_props, "Android版本号不是CACHE110基线")
    check('APP_VERSION_NAME=2.1.1-cache110' in gradle_props, "Android版本名不是CACHE110基线")
    expected_build = "v2-1-1-cache110-forgeui2-admin22-sql239"
    ...
    result = {
        ...
        "project": ROOT.name,
        "gameBaseline": "V2.1.1 CACHE110",
        "gameBuildId": expected_build,
        "databaseBaseline": "SQL211-221 + SQL229-239 (target; SQL239 gate pending)",
        "androidVersionCode": 2001410,
    }
