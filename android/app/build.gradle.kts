...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001203").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.0.11-cache103").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-0-11-cache103-sectui3-autobreak1-outcome2-appupdate2"))
    }
