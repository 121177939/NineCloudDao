...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001410").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.1.1-cache110").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-1-1-cache110-forgeui2-admin22-sql239"))
    }
