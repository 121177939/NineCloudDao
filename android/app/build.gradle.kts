...
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.5.0-cache141").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-5-0-cache141-decompose-modal-scrollfix-admin41-sql268r1"))
    }
