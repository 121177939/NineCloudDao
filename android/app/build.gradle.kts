...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001001").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.0.9-cache101").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-0-9-cache101-secttempo1-eventoutcome1-cleanrepo1-huaweinet1-appdialogupdate1"))
    }
