...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001506").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.2.0-cache127").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-2-0-cache127-tianxu-detail-admin34-sql258"))
    }
