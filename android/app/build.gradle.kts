...
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.5.0-cache138").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-5-0-cache138-spirit-beast-complete-admin41-sql267-gated"))
    }
