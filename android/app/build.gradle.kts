...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001304").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.0.12-cache104").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-0-12-cache104-authversion1-sectlimit100-deploylock1"))
    }
