...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2000497").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.0.4-cache96-app2").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-0-4-cache96-equipment-worldnews3-branchpublish2-appautoupdate1"))
    }
