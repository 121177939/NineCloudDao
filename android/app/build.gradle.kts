...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001406").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.1.1-cache106").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-1-1-cache106-wboss01-equipmentforge1-admin21-sql233-pagesfix1-gatefix1"))
    }
