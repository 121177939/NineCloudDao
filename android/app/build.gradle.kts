...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001511").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.2.0-cache132").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-2-0-cache132-pc-bottom-nav-drag-admin38-sql260-online"))
    }
