...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001407").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.1.1-cache107").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-1-1-cache107-wboss01-equipmentforge1-admin21-sql235-readyfix1"))
    }
