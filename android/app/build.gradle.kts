...
val appVersionCode = providers.gradleProperty("APP_VERSION_CODE").orElse("2001102").get().toInt()
val appVersionName = providers.gradleProperty("APP_VERSION_NAME").orElse("2.0.10-cache102").get()
...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "GAME_BUILD_ID", quoted("v2-0-10-cache102-sectui2-breakthroughmanual1-appupdate2"))
    }
