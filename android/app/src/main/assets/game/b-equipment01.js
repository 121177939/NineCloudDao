(() => {
  ...
  const VERSION = '2.0.11-cache103-equipment-worldnews3-pagesrecovery2-huaweinet1-appdialogupdate1';
  ...
  window.B_EQUIPMENT01 = { refresh, render: renderAll, openBackpack, version: VERSION };
})();
