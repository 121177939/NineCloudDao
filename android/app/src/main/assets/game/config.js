// 《九霄问道》V2.2.0 CACHE130 · 天道人物 Cloudflare AI 正式接入
// 这里只保存可公开的浏览器客户端配置；服务端凭据全部由后端环境变量管理。
window.GAME_CONFIG = Object.freeze({
  ...
  gameName: '九霄问道',
  version: '2.2.0',
  releaseLabel: 'V2.2.0 CACHE130',
  buildId: 'v2-2-0-cache130-tiandao-interaction-ux-admin37-sql259-online',
  cacheEpoch: 130,
