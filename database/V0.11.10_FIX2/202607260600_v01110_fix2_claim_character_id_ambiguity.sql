-- NineCloudDao V0.11.10 FIX2
-- Runtime hotfix: resolve PL/pgSQL output-column ambiguity in claim_cultivation_v1().
-- Safe to run after V0.11.10 FIX1. No table/data changes.
