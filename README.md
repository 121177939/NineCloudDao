# 九霄问道 V2.1.1 CACHE106：世界BOSS / 装备8孔统一升级候选

当前客户端目标基线：**V2.1.1 CACHE106**。

本版从 V2.0.12 CACHE104 选择性集成 B-WBOSS01，并加入装备孔位/洗练/器魂/升品破境、元神总属性弹窗与 ADMIN9 R21。**没有整包覆盖 CACHE104**。

- Web：V2.1.1 CACHE106，Build `v2-1-1-cache106-wboss01-equipmentforge1-admin21-sql233-pagesfix1-gatefix1`。
- Android：`versionCode=2001406`，`versionName=2.1.1-cache106`，内置游戏资源已同步。
