# 九霄问道 V2.2.0 CACHE124

当前开发交付基线：**V2.2.0 CACHE124**；Android：**versionCode 2001503 / versionName 2.2.0-cache124**；GM：**ADMIN9 R34**。

生产数据库已经由用户截图确认 **SQL254 R5 ONLINE / SQL254_GATE_PASSED**。本版需要执行 **SQL255**，在确认 `SQL255_GATE_PASSED` 之前不得发布 CACHE124；成功后下一SQL编号为 **SQL256**。
